        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          {/* <div className="max-w-3xl mx-auto text-center text-gray-200 pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Chúng tôi cung cấp 1 hệ thống giúp mọi người bình chọn ứng cử viên
              sáng giá cho các chiến dịch
            </p>
          ...
          <section>
            {/* {Array.isArray(data) ? (
              data.map((i) => {
                return (
                  <div key={i.campaignId}>
                    <p className="text-white">{i.title}</p>
                    {i.stage.map((stage: any) => (
                                              ...
                                              <div className="flex items-center space-x-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                  ...
                                                  <p className="text-sm text-gray-500 truncate dark:text-gray-400">
                                                    Côde nữa code mãi code quài
                                                    code dai
                                                    <br />
                                                    code dại code quá chời code
                                                    kinh
                                                    <br />
